 ...
 * 事件关闭解析
 */
public class CloseEventParser {
	public Map<String, String> map;
	private final WeakReference<OnDataCompleterListener> wr;

	public CloseEventParser(String id,
	...
	public void request(final String id) {
		...
		RequestParams params = new RequestParams(DemoApplication.getInstance().getUrl()+HttpUrl.CLOSEEEVENT);
	 ...
	 */
	public Map<String, String> closeEventParser(String t) {
