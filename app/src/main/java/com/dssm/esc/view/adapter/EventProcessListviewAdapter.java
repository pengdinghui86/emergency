 ...
 */
public class EventProcessListviewAdapter extends BaseAdapter {
	...
	public EventProcessListviewAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(
					R.layout.item_listview_event_process, null);
			...
			mhHolder.event_type_tv = (TextView) convertView
					.findViewById(R.id.event_type_tv);
		...
		if (tags.equals("6") || tags.equals("7")) {// 事件列表
			...
			mhHolder.event_type_tv.setText(entity.getEveLevel());
