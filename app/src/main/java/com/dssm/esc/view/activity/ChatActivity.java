...
import com.dssm.esc.view.adapter.ExpressionAdapter;
import com.dssm.esc.view.adapter.ExpressionPagerAdapter;
import com.dssm.esc.view.adapter.MessageAdapter;
import com.dssm.esc.util.VoicePlayClickListener;
import com.dssm.esc.util.CommonUtils;
import com.dssm.esc.util.SmileUtils;
import com.dssm.esc.view.widget.ExpandGridView;
                ...
                try {
                    ...
                    if (buttonSetModeKeyboard.getVisibility() != View.VISIBLE) {
                        ...
                        if (filename != "delete_expression") { // 不是删除键，显示表情
                            ...
                            Class clz = Class.forName("com.dssm.esc.util.SmileUtils");
