...
public class MergeHeadViewGroup<T> extends ViewGroup {
    ...
    private List<Integer> mImgDataList;

    private NineGridImageViewAdapter mAdapter;

    public MergeHeadViewGroup(Context context) {
        this(context, null);
    }

    public MergeHeadViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MergeHeadViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public abstract static class NineGridImageViewAdapter {
        protected abstract void onDisplayImage(Context context, ImageView imageView, Integer t);
