 ...
 */
public class AdressListFailsafeAdressListFragment extends BaseFragment
...
//				service.saveContactName(groupList);// 将联系人存到本地
	...
	public AdressListFailsafeAdressListFragment() {
	}
	/**
	 * 页面隐藏后再显示回调此方法，刷新界面
	 */
	...
	public AdressListFailsafeAdressListFragment(Context context) {
	...
	protected void widgetListener() {
		...
		expandableListView.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				// if (group.getIschecked()==true||child.getIsChecked()==true) {
