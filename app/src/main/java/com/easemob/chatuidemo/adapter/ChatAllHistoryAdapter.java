	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (conversation.getType() == EMConversationType.GroupChat) {
			...
			if (robotMap != null && robotMap.containsKey(username)) {
				...
				// UserUtils.setUserNick(name, holder.name);
				// service.saveContactName(username.replace("_", "-"), username)
				final String userId = username.replace("_", "-");
				 String getcontectName = service.getcontectName(userId);
				if (!getcontectName.equals("")
						&& !getcontectName.equals("null")
						&& getcontectName != null) {
