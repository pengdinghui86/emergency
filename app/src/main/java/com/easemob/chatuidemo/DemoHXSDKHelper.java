...
public class DemoHXSDKHelper extends HXSDKHelper {
    ...
    private MySharePreferencesService myspf;
    ...
    public synchronized boolean onInit(Context context){
        if(super.onInit(context)){
            ...
            myspf=MySharePreferencesService.getInstance(context);
            return true;
        }
    ...
    protected void initEventListener() {
        eventListener = new EMEventListener() {
            ...
            public void onEvent(EMNotifierEvent event) {
                ...
                case EventNewCMDMessage:
                {
                    ...
                    final String CMD_TOAST_BROADCAST = "com.easemob.demo.cmd.toast";
        ...
        EMChatManager.getInstance().addChatRoomChangeListener(new EMChatRoomChangeListener(){
            private final static String ROOM_CHANGE_BROADCAST = "com.easemob.demo.chatroom.changeevent.toast";
        ...
        return new HXNotifier.HXNotificationInfoProvider() {
            ...
            public String getDisplayedText(EMMessage message) {
    			...
    			if(robotMap!=null&&robotMap.containsKey(message.getFrom())){
    				...
    				Log.i("环信消息通知userID", message.getFrom());
    				Log.i("环信消息通知", myspf.getcontectName(message.getFrom().replace("_", "-"))+"------");
    				return myspf.getcontectName(message.getFrom().replace("_", "-")) + ": " + ticker;
    			}
            }
                ...
                //    intent = new Intent(appContext, VideoCallActivity.class);
                  ...
                  //  intent = new Intent(appContext, VoiceCallActivity.class);
                    ...
                    if (chatType == EMMessage.ChatType.Chat) { // 单聊信息
                        ...
                        intent.putExtra("name", myspf.getcontectName(message.getFrom().replace("_", "-")));
